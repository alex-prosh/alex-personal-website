...
export default function DRSPage() {
  return (
    <div style={{ background: 'var(--bg)', color: 'var(--crimson)' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(22,36,58,0.15)', borderBottom: '1px solid rgba(22,36,58,0.15)', background: '#F3EFE4', padding: '56px min(14%, 200px)' }}>
      ...
      {/* ── Timeline ── */}
      <div style={{ borderTop: '1px solid rgba(22,36,58,0.15)', padding: '72px min(14%, 200px)', background: '#F3EFE4' }}>
